...
import { View, Text, Image, StyleSheet, TouchableOpacity, ScrollView, Animated,Dimensions, Alert, RefreshControl } from 'react-native';
// import theme from '../../common/color'
// import {width} from '../../common/screen'
import MessageView from './itemDetailItem'
        ...
        return (
            ...
            <View style={styles.imgWrapper}>
                ...
                <View style={styles.chooseLine}>
                    ...
                    <TouchableOpacity style={[styles.button,{paddingLeft: 24,paddingRight: 10}]} onPress={()=>alert('注释116行')}>
